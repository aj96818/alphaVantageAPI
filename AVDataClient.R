...
weekly_data <- getHistoricalWeeklyPrices(paste0(path, "allActiveTickers.csv"), PREMIUM_API_KEY)
eps_data <- getEPSdata(paste0(path, "allActiveTickers.csv"), PREMIUM_API_KEY)
